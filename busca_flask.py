...
PASTAS = {
    "fathers": os.path.join(BASE_DIR, "textos", "fathers"),
    "library": os.path.join(BASE_DIR, "textos", "library"),
    "bible": os.path.join(BASE_DIR, "textos", "bible"),
    "cathen": os.path.join(BASE_DIR, "textos", "cathen"),
    "douay": os.path.join(BASE_DIR, "textos", "douay"),
    "summa": os.path.join(BASE_DIR, "textos", "summa")
}
